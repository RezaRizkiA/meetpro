        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6 order-last order-lg-first">
                        <div class="p-4 p-lg-5 flex-grow-1">
                            <div class="py-lg-4 d-flex flex-column gap-3">
                                ...
                                <p class="">
                                    Di era pendidikan yang terus berkembang, kebutuhan akan bimbingan yang tepat — baik
                                    secara akademik, emosional, maupun karakter — menjadi semakin penting.
                                    <br><br>Dengan platform ini kami percaya kolaborasi antara sekolah, keluarga, dan para
                                    profesional merupakan kunci untuk menciptakan lingkungan belajar yang sehat.
                                </p>
                    ...
                    <div class="col-lg-6 order-first order-lg-last">
                        <div class="blog-bg d-flex flex-column justify-content-between p-9 h-100 flex-grow-1">
                            <img src="{{ asset('assets/images/profile/user-6.jpg') }}" alt="user" width="44"
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-3 overflow-hidden">
                        <a href="{{ route('expert') }}" class="position-relative">
                            <img src="{{ asset('assets/images/frontend-pages/blog-2.jpg') }}" alt="blog image"
                                class="w-100 img-fluid">
                            <div class="position-absolute bottom-0 ms-7 mb-n9">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-3 overflow-hidden">
                        <a href="{{ route('expert') }}" class="position-relative">
                            <img src="{{ asset('assets/images/frontend-pages/blog-3.jpg') }}" alt="blog image"
                                class="w-100 img-fluid">
                            <div class="position-absolute bottom-0 ms-7 mb-n9">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-3 overflow-hidden">
                        <a href="{{ route('expert') }}" class="position-relative">
                            <img src="{{ asset('assets/images/frontend-pages/blog-4.jpg') }}" alt="blog image"
                                class="w-100 img-fluid">
                            <div class="position-absolute bottom-0 ms-7 mb-n9">
                                <img src="{{ asset('assets/images/profile/user-1.jpg') }}" alt="user"
                                    class="rounded-circle" width="44px" height="44px">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-3 overflow-hidden">
                        <a href="{{ route('expert') }}" class="position-relative">
                            <img src="{{ asset('assets/images/frontend-pages/blog-5.jpg') }}" alt="blog image"
                                class="w-100 img-fluid">
                            <div class="position-absolute bottom-0 ms-7 mb-n9">
                                <img src="{{ asset('assets/images/profile/user-3.jpg') }}" alt="user"
                                    class="rounded-circle" width="44px" height="44px">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-3 overflow-hidden">
                        <a href="{{ route('expert') }}" class="position-relative">
                            <img src="{{ asset('assets/images/frontend-pages/blog-6.jpg') }}" alt="blog image"
                                class="w-100 img-fluid">
                            <div class="position-absolute bottom-0 ms-7 mb-n9">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-3 overflow-hidden">
                        <a href="{{ route('expert') }}" class="position-relative">
                            <img src="{{ asset('assets/images/frontend-pages/blog-7.jpg') }}" alt="blog image"
                                class="w-100 img-fluid">
                            <div class="position-absolute bottom-0 ms-7 mb-n9">
                                <img src="{{ asset('assets/images/profile/user-5.jpg') }}" alt="user"
                                    class="rounded-circle" width="44px" height="44px">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-3 overflow-hidden">
                        <a href="{{ route('expert') }}" class="position-relative">
                            <img src="{{ asset('assets/images/frontend-pages/blog-8.jpg') }}" alt="blog image"
                                class="w-100 img-fluid">
                            <div class="position-absolute bottom-0 ms-7 mb-n9">
                                <img src="{{ asset('assets/images/profile/user-2.jpg') }}" alt="user"
                                    class="rounded-circle" width="44px" height="44px">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card rounded-3 overflow-hidden">
                        <a href="{{ route('expert') }}" class="position-relative">
                            <img src="{{ asset('assets/images/frontend-pages/blog-9.jpg') }}" alt="blog image"
                                class="w-100 img-fluid">
                            <div class="position-absolute bottom-0 ms-7 mb-n9">
                                <img src="{{ asset('assets/images/profile/user-1.jpg') }}" alt="user"
                                    class="rounded-circle" width="44px" height="44px">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-910 text-center">
                    ...
                    <p class="text-white fs-5 mb-9 px-xl-11">
                        Manfaatkan layanan ini untuk berkonsultasi, mendapatkan pendampingan, atau mencari solusi terbaik
                        demi masa depan siswa yang lebih cerah dan seimbang.
                    </p>
