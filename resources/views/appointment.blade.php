                  ...
                  <tr>
                    <td class="border-bottom-0">
                      <div class="d-flex align-items-center gap-3 overflow-hidden">
                        <img src="{{asset('image/kirdi-putra.jpeg')}}" alt="matdash-img" class="img-fluid rounded" width="80">
                        <div>
                          <h6 class="fw-semibold fs-4 mb-0">Kirdi Putra</h6>
                          <p class="mb-0">Microexpression expert</p>
                        </div>
                      </div>
                    </td>
                    <td class="border-bottom-0">
                    ...
                    <td class="text-end border-bottom-0">
                      <h6 class="fs-4 fw-semibold mb-0">Rp. 100.000</h6>
                    </td>
                  </tr>
                </tbody>
              </table>
