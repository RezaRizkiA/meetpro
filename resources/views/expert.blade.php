  ...
  <section class="pt-5 pt-md-14 pb-4 pb-md-5">
    <div class="container-fluid">
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h3 class="mb-3 mb-sm-0 fw-semibold d-flex align-items-center">Expert <span class="badge text-bg-secondary fs-2 rounded-4 py-1 px-2 ms-2">2</span>
        </h3>
        <form class="position-relative">
          <input type="text" class="form-control search-chat py-2 ps-5" id="text-srh" placeholder="Search Expert">
        ...
        <div class="col-md-3">
          <a href="{{route('expert_detail')}}" class="card overflow-hidden">
            <div class="position-relative">
              ...
              <div class="position-absolute start-50 translate-middle-x bottom-5 bg-white rounded shadow py-3 px-2 text-center w-90">
