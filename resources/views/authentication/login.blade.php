                ...
                <div class="row justify-content-center py-4">
                  <div class="col-lg-11">
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-12">
                          <a class="btn btn-white shadow-sm text-dark link-primary border fw-semibold d-flex align-items-center justify-content-center rounded-1 py-6" href="{{route('google_redirect')}}" role="button">
                      ...
                      <form>
                        <div class="mb-3">
                          ...
                          <input type="email" class="form-control" id="email" placeholder="Enter your google email" aria-describedby="">
                        </div>
                        <div class="mb-4">
                        ...
                        <a href="" class="btn btn-dark w-100 py-8 mb-4 rounded-1">Sign In</a>
                        <div class="d-flex align-items-center justify-content-center">
                          <p class="fs-12 mb-0 fw-medium">Don’t have account?</p>
                          <a class="text-primary fw-bolder ms-2" href="{{route('google_redirect')}}">Sign in &nbsp;Google</a>
                        </div>
                      </form>
                    </div>
                  </div>
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <div class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                            <img src="{{asset('image/choose-expert.png')}}" alt="login-side-img" width="300" class="img-fluid" />
                            <h4 class="mb-0">Choose profesional expert</h4>
                            <p class="fs-12 mb-0">Tentukan expert yang sedang di butuhkan, kenali profile dan jadwal available nya</p>
                          </div>
                        </div>
                        <div class="carousel-item">
                          <div class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                            <img src="{{asset('image/complate-payment.png')}}" alt="login-side-img" width="300" class="img-fluid" />
                            <h4 class="mb-0">Payment and make Appointment</h4>
                            <p class="fs-12 mb-0">Selesaikan pembayaran lalu buat janji dengan profesional yang di butuhkan</p>
                          </div>
                        </div>
                        <div class="carousel-item">
                          <div class="d-flex align-items-center justify-content-center w-100 h-100 flex-column gap-9 text-center">
                            <img src="{{asset('image/confirm-schedule.png')}}" alt="login-side-img" width="300" class="img-fluid" />
                            <h4 class="mb-0">Confirmation Schedule with Expert</h4>
                            <p class="fs-12 mb-0">Setelah Appointment terbuah lalu konfirmasi dengan expert dan mungkin bisa berubah Schedule.</p>
                          </div>
                        </div>
                      </div>
