            ...
            <div class="col-md-8">
                <div class="card text-center border shadow-sm">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <p class="text-muted">Segera lakukan pembayaran sebelum tanggal kedaluwarsa: <br><strong
                                class="text-danger">{{ optional($transaction->expired_date)->translatedFormat('d F Y, l') }}
                                Pukul {{ optional($transaction->expired_date)->format('H:i') }} WIB</strong></p>
                        ...
                        <div class="mb-4">
                            @if ($transaction->via === 'QRIS')
                                ...
                                {{-- Menyiapkan data URI untuk QR code satu kali agar lebih efisien --}}
                                @php
                                    $qrCodeDataUri =
                                ...
                                <div class="text-center bg-light p-3 rounded">
                                    ...
                                    <img src="{{ $qrCodeDataUri }}" alt="QRIS" class="img-fluid d-block mx-auto"
                                        style="max-width: 150px;">

                                    {{-- Tombol Download yang mengarah ke data URI gambar --}}
                                    <a href="{{ $qrCodeDataUri }}" download="QRIS_{{ $transaction->name }}.png"
                            ...
                            @else
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-2 bg-light p-3 rounded">
                                    <h3 class="fw-bolder text-primary mb-0" id="paymentNumber">{{ $transaction->paymentNo }}
                                    </h3>
                        ...
                        <div class="alert alert-info mt-4">
                            Silakan selesaikan pembayaran melalui ATM, Internet Banking, atau Mobile Banking. Setelah
                            pembayaran berhasil, status akan diperbarui secara otomatis.
                        </div>
